          ...
          <div className="container">
            <div className="row">
              <div className="col-md-7 col-sm-6 wow slideInLeft intro-content animated" data-wow-delay=".3s">
                ...
                <h4 className="sub-title">We are award winning representation and a historic track record by a former partner of the legendary <a href="#">Tohnnie L. Hochran</a> and former managing partner of The Firm in New Hampsire.</h4>
                <p>
                  ...
                  <div className="panel panel-default">
                    <div className="panel-heading">
                      <h4 className="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">We are reliable partner</a>
                      </h4>
                    </div>
